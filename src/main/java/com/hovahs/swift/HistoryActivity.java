...
import com.hovahs.swift.historyRecyclerView.HistoryAdapter;
import com.hovahs.swift.historyRecyclerView.HistoryObject;
                ...
                if(dataSnapshot.exists()){
                    ...
                    if(dataSnapshot.child("customerPaid").getValue() != null && dataSnapshot.child("driverPaidOut").getValue() == null){
                        if(dataSnapshot.child("price").getValue() != null){
                            ...
                            Balance += ridePrice;
                            mBalance.setText(getString(R.string.balance) + ":" + String.valueOf(Balance) + " $");
                        }
                    }
